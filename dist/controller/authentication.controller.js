...
let AuthenticationController = class AuthenticationController extends tsoa_1.Controller {
    ...
    sendVerifyCode(dto) {
        return __awaiter(this, void 0, void 0, function* () {
            return authentication_service_1.AuthenticationService.sendVerifyCode(dto);
        });
    }
    createUser(dto) {
        return __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    (0, tsoa_1.Post)("/send-code-email"),
    __param(0, (0, tsoa_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuthenticationController.prototype, "sendVerifyCode", null);
__decorate([
